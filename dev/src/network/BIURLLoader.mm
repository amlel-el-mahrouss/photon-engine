...
namespace Photon
{
	...
	String IURLLoader::put(URL& url, String data, bool cache_data)
	{
		...
		auto http_request = HTTP::IHTTPHelper::form_request(url.get(), mEndpoint, HTTP::PHOTON_HTTP_PUT, data.size(), headers, data);
	...
	String IURLLoader::del(URL& url, String data, bool cache_data)
	{
		...
		auto http_request = HTTP::IHTTPHelper::form_request(url.get(), mEndpoint, HTTP::PHOTON_HTTP_DELETE, data.size(), headers, data);
	...
	String IURLLoader::post(URL& url, String data, bool cache_data)
	{
		...
		auto http_request = HTTP::IHTTPHelper::form_request(url.get(), mEndpoint, HTTP::PHOTON_HTTP_POST, data.size(), headers, data);
	...
	String IURLLoader::get(URL& url, bool cache_data)
	{
		...
		auto http_request = HTTP::IHTTPHelper::form_request(url.get(), mEndpoint, HTTP::PHOTON_HTTP_GET, 0, headers);
